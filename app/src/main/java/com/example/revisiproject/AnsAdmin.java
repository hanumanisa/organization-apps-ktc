...
public class AnsAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ans_admin);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    TextView textView = new TextView(AnsAdmin.this);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AnsAdmin.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}