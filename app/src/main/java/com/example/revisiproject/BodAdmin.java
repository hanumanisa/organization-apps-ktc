...
public class BodAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bod_admin);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    TextView textView = new TextView(BodAdmin.this);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(BodAdmin.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}