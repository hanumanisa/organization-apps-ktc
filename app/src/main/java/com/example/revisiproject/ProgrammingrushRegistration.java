...
public class ProgrammingrushRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programmingrush_registration);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(ProgrammingrushRegistration.this, "User data not found!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(DatabaseError error) {
                Toast.makeText(ProgrammingrushRegistration.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveRegistrationData(String nama, String email, String major, String batch, String fee) {
        DatabaseReference competitionRef = database.child("Programming Rush Competition").child(nama);
        competitionRef.child("name").setValue(nama);
        competitionRef.child("email").setValue(email);
        competitionRef.child("major").setValue(major);
        competitionRef.child("batch").setValue(batch);
        competitionRef.child("fee").setValue(fee);
